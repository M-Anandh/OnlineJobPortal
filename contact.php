					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> TCE, <br/> PO.BOX AX40, <br/>Madurai</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:anandhm@student.tce.edu">anandhm@student.tce.edu</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+7824964859">7824964829</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : TCE,Madurai </p>
								<p>Email : <a href="mailto:anandhm@student.tce.edu">anandhm@student.tce.edu</a></p>
								<p>Phone : <a href="tel:7824964826">7824964829</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Online Job Portal@2023</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Students</a></li>
								</ul>
